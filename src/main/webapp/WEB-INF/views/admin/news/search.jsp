    ...
    <form action="<c:url value='/admin-news/list'/>" id="formSubmit" method="get">
        ...
        <div class="card-body">
            <div class="table-responsive">
                        ...
                        <tr>
							...
							<td>
								...
								<a class="btn btn-warning btn-circle" data-toggle="tooltip"
								   title="Update article" href="${updateNewsURL}"><i class="fas fa-exclamation-triangle" aria-hidden="true"></i>
								</a>
				...
				<input type="hidden" value="<fmt:message key='label.limit.page' bundle='${lang}'/>" id="limit" name="limit"/>
            </div>
        </div>
    </form>
    </div>
...
function deleteNews(data) {
	$.ajax({
        ...
        success: function (result) {
        	window.location.href = "${newsURL}?page=1&limit=10&message=delete_success";
        },
